...
class Scale:
    ...
    def calculate_base_scale(self) -> Optional[float]:
        """
    ...
    def calculate_scale_factor_power(self) -> Optional[float]:
        ...
        if self._scale_factor_power is None:
            self._scale_factor_power = math.pow(self.scale_factor, self.iteration)
    ...
    def calculate_scale(self) -> Optional[float]:
        ...
        if self._scale is None:
            self._scale = self.base_scale * self.scale_factor_power
        return self._scale
    ...
    def calculate_log_scale(self) -> Optional[float]:
        ...
        if self._log_scale is None:
            self._log_scale = math.log10(self.scale)
...
class SystemStats:
    ...
    def calculate_system_display_name(self) -> str:
        """
    ...
    def calculate_theoretical_log_log_slope(self) -> Optional[float]:
        """
    ...
    def calculate_min_log_scale(self, scales: List[Scale]) -> Optional[float]:
        ...
        if self._min_log_scale is None:
            self._min_log_scale = min((calc_scales_log_scale(s.scales_id) for s in scales if s.system == self.system), default=0)
    ...
    def calculate_max_log_scale(self, scales: List[Scale]) -> Optional[float]:
        ...
        if self._max_log_scale is None:
            self._max_log_scale = max((calc_scales_log_scale(s.scales_id) for s in scales if s.system == self.system), default=0)
    ...
    def calculate_min_log_measure(self, scales: List[Scale]) -> Optional[float]:
        ...
        if self._min_log_measure is None:
            self._min_log_measure = min((calc_scales_log_measure(s.scales_id) for s in scales if s.system == self.system), default=0)
    ...
    def calculate_max_log_measure(self, scales: List[Scale]) -> Optional[float]:
        ...
        if self._max_log_measure is None:
            self._max_log_measure = max((calc_scales_log_measure(s.scales_id) for s in scales if s.system == self.system), default=0)
    ...
    def calculate_delta_log_measure(self) -> Optional[float]:
        ...
        if self._delta_log_measure is None:
            self._delta_log_measure = self.min_log_measure - self.max_log_measure
    ...
    def calculate_delta_log_scale(self) -> Optional[float]:
        ...
        if self._delta_log_scale is None:
            self._delta_log_scale = self.max_log_scale - self.min_log_scale
    ...
    def calculate_empirical_log_log_slope(self) -> Optional[float]:
        ...
        if self._empirical_log_log_slope is None:
            self._empirical_log_log_slope = self.delta_log_measure / self.delta_log_scale
    ...
    def calculate_slope_error(self) -> Optional[float]:
        ...
        if self._slope_error is None:
            self._slope_error = self.empirical_log_log_slope - self.theoretical_log_log_slope
